...
import threebg from '../../assets/images/03photos/food/1Z6A1114.jpg';
                            ...
                            <div className="inner clearfix wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                                <div className="content-box">
                                    <div className="title-box centered">
                                        ...
                                        <div className="text">Enjoy being served a captivating ambience by a team passionate about making your time at the No3 Lounge the best part of your day.</div>
                                    </div>
                                    <div className="link-box">
